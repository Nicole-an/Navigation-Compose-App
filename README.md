...
Aplicativo desenvolvido em Android utilizando Jetpack Compose com o objetivo de demonstrar a navegação entre telas e a passagem de parâmetros entre elas.
