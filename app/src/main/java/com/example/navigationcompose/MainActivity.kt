...
import com.example.navigationcompose.ui.theme.NavigationComposeAppTheme
import com.example.navigationcompose.ui.theme.screens.LoginScreen
            ...
            Android5navigationbetweenscreensTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    ...
                    composable(
                        ...
                        val nome: String? = it.arguments?.getString("nome", "Usuário Nicole")
                        val idade: Int? = it.arguments?.getInt("idade", 20)
                        PerfilScreen(
                            modifier = Modifier.padding(innerPadding),
                            navController,
                            nome!!,
